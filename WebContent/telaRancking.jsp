...
<div id="divCenters">       
        <table width="80%" border="0" cellspacing="1px" cellpadding="0" bgcolor="">
            <caption><b>RANCKING DE LEITORES COM MAIOR PONTUAÇÃO </b></caption>
            <tr bgcolor="#9AC0CD" align="center"><td> <b> ID</b></td> <td><b>USUÁRIO</b></td> <td><b> GENERO </b></td>  <td><b> PONTOS </b></td> </tr>
            <%
            
                Usuario user = new Usuario();
                user.setLogin(login);
            	RanckingFacade ranck = new RanckingFacade();
				List<Pontos> lista = ranck.listaTodos();   
